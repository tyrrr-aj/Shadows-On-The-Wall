    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('comments', models.ManyToManyField(blank=True, to='revolution.Comment')),
            ],
        ),
        migrations.CreateModel(
            name='Tag',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('entry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='revolution.Entry')),
                ('improvements', models.ManyToManyField(blank=True, related_name='_solution_improvements_+', to='revolution.Solution')),
        ...
        migrations.AddField(
            model_name='problem',
            name='solutions',
            field=models.ManyToManyField(blank=True, to='revolution.Solution'),
        ),
        migrations.AddField(
            model_name='problem',
            name='tags',
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('entry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='revolution.Entry')),
                ('improvements', models.ManyToManyField(blank=True, related_name='_initiative_improvements_+', to='revolution.Initiative')),
