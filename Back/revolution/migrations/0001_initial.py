# Generated by Django 3.0.2 on 2020-01-12 04:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date_time', models.DateTimeField(default=datetime.datetime(2020, 1, 12, 4, 33, 25, 180612))),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('entry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='revolution.Entry')),
                ('improvement_of', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='revolution.Solution')),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ('entry_ptr', models.OneToOneField(auto_created=True, on_delete=django.db.models.deletion.CASCADE, parent_link=True, primary_key=True, serialize=False, to='revolution.Entry')),
                ('improvement_of', models.ForeignKey(blank=True, default=None, null=True, on_delete=django.db.models.deletion.SET_NULL, to='revolution.Initiative')),
